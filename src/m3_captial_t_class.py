...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        top_rect = rg.Point(intersection_center.x - (width / 2),
                            intersection_center.y - (letter_thickness / 2))

        bot_rect = rg.Point(intersection_center.x + (width / 2),
                            intersection_center.y + (letter_thickness / 2))

        longtop = rg.Point(intersection_center.x - (letter_thickness / 2),
                           intersection_center.y - (letter_thickness / 2))

        longbot = rg.Point(intersection_center.x + (letter_thickness / 2),
                           intersection_center.y + height - (
                           letter_thickness / 2))

        self.h_rect = rg.Rectangle(top_rect, bot_rect)

        self.v_rect = rg.Rectangle(longtop, longbot)
    ...
    def clone(self):
        ...
        t = CapitalT(self.h_rect.get_center(), self.h_rect.get_width(),
